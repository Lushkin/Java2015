...
public class AdminController extends HttpServlet
{
	...
	private void EditPromotion(HttpServletRequest req, HttpServletResponse rep) throws ServletException, IOException
	{
	...
	private void EditEtudiant(HttpServletRequest req, HttpServletResponse rep) throws ServletException, IOException, ParseException
	{
		int id = Integer.parseInt(req.getParameter("id"));
		String prenom = req.getParameter("Prenom");
		String nom = req.getParameter("Nom");
	...
	private void DeletePromotion(HttpServletRequest req, HttpServletResponse rep) throws ServletException, IOException
	{
		...
		try
		{
			List<Users> users = HibernateUtil.currentSession().createQuery("from Users WHERE PromotionId = " + id).list();
			for (Users user : users)
			{
				user.setPromotions(null);
				DataAccess.Users().UpdateUser(user.getId(), user.getLastName(), user.getFirstName(), user.getEmail(), user.getBirthDate(), user.getPassword());
			}
	...
	private void DeleteProf(HttpServletRequest req, HttpServletResponse rep) throws ServletException, IOException
	{
		int id = Integer.parseInt(req.getParameter("id"));
	...
	private void GetStudentsWithPromo(HttpServletRequest req, HttpServletResponse rep)
	{
		List<Users> students = DataAccess.Users().GetStudentsWithPromo();
		req.setAttribute("Students", students);
	}
